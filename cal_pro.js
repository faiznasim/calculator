...
function calculate(number1, number2, num1_base, num2_base, sign) {
    ...
    xhttp.open("GET", "http://localhost/calculator/cal_pro.php?f_num="+number1 + "&s_num="+number2 + "&f_num_base="+num1_base + "&s_num_base="+num2_base + "&opr="+sign, true);
    xhttp.send();
  }
  ...
  function equalbutton()
  {
    ...
    calculate(num1,num2,base1,base2,op);
  }